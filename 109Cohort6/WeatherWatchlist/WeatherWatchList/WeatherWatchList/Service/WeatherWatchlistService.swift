...
final class WeatherService{
    ...
    // MARK: - Step 1: City -> Coordinates
        private func fetchCoordinates(forCity city:String) async throws -> GeocodingResult{
            ...
            //Base URL
            var urlComponents: URLComponents? = URLComponents(string: "https://api.open-meteo.com/v1/forecast?latitude=52.52&longitude=13.41&hourly=temperature_2m&utm_source=chatgpt.com&format=flatbuffers")
